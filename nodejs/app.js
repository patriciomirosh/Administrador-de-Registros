...
app.post('/create', (req, res) => {
  const sql = 'CREATE TABLE `node20_mysql`.`admper`(ID INT NOT NULL  AUTO_INCREMENT, Concepto TEXT NOT NULL , Monto FLOAT NOT NULL , Fecha DATE NOT NULL , Tipo VARCHAR NOT NULL ,PRIMARY KEY (ID))';
